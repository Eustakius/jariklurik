...
<body>
<div id="fadeDiv" class="fixed top-0 left-0 w-full bg-blue-500 text-white p-4 text-center pointer-events-none">
  Menghilang secara smooth sesuai scroll
</div>

<div class="h-[2000px] bg-gray-100 p-4">
  Scroll ke bawah untuk melihat transisi
</div>

  ...
  <div class="shadow-lg bg-white flex flex-col rounded-[0.938rem] w-full pb-16">
    <div class="flex flex-wrap items-center gap-4 justify-between p-7 md:px-14 md:pt-14 md:pb-11">
      ...
      <div class="flex gap-5 md:gap-16">
        <span>
          <input name="type" type="radio" id="option1" class="post-back with-gap" value="daftar-kepelatihan-pencari-kerja" />
          <label for="option1" class="!text-lg !md:text-[2rem] !font-bold !text-black">Pencari kerja</label>
        </span>
        <span>
          <input name="type" type="radio" id="option2" checked class="post-back with-gap" value="daftar-kepelatihan-purna-pmi" />
    ...
    <?php if (empty($data_master['training_type'])): ?>
      <div class="p-5 md:p-10 flex flex-col gap-4 md:gap-7 justify-center items-center">
        ...
        <p class="text-lg md:text-2xl font-bold">Mohon maaf saat ini pelatihan Purna PMI belum tersedia.</p>
      </div>
    <?php else: ?>
      ...
      <form class="px-7 md:px-14 text-sm md:text-lg flex flex-col gap-8" action="<?= base_url('submit/purna-pmi') ?>" method="post" enctype="multipart/form-data" data-parsley-validate>
        ...
        <div class="flex flex-wrap gap-x-[60px] gap-y-8 mt-16 w-full">
          <div class="w-full">
            <div class="form-group form-float">
              <div class="form-line">
                <select class="form-control" id="yearSelect" required name="end_year">
                  <option value=""></option>
                  <?php
                  $currentYear = date("Y");
                  $startYear = $currentYear - 50;
                  for ($year = $currentYear; $year >= $startYear; $year--) {
                    $selected = old('end_year') == $year ? "selected" : "";
                    echo "<option $selected value=\"$year\">$year</option>";
                  }
                  ?>
                </select>
                <label class="form-label">Tahun Kembali ke Indonesia</label>
              </div>
            </div>
          </div>
            ...
            <div class="form-group form-float">
              <div class="form-line">
                <label for="upload-file" class="file-upload w-full justify-between flex form-control focused cursor-pointer items-center" id="trigger-upload">
                  <div id="file-info" class="mt-2 span">
                ...
                <input type="file" id="upload-file" name="file" class="form-control hidden" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required
                ...
                <label for="upload-file" class="form-label">Upload Stamp Passport Imigrasi</label>
              </div>
          ...
          <div class="w-full md:w-[calc(50%-30px)]">
            <div class="form-group form-float">
              <div class="form-line">
                <select class="form-control" id="mySelect" required name="gender">
                  <option value=""></option>
            ...
            <div class="form-group form-float">
              <div class="form-line">
                <input type="text" name="phone" class="form-control" value="<?= old('phone') ?>"
                  maxlength="20"
                  data-parsley-phoneid data-parsley-trigger="change"
        ...
        <div class="flex flex-wrap gap-x-[60px] gap-y-8 mb-16 w-full">
          ...
          <div class="w-full md:w-[calc(50%-30px)]">
            <div class="form-group form-float">
              <div class="form-line">
                <select class="form-control" id="mySelect" required name="education_level">
                  <option value=""></option>
          ...
          <div class="w-full md:w-[calc(50%-30px)]">
            <div class="form-group form-float">
              <div class="form-line">
                <select class="form-control" id="mySelect" required name="training_type">
                  <option value=""></option>
        ...
        <button class="w-full text-base text-[#714D00] font-bold rounded-[10px] border-[3px] border-[#714D00] py-2 px-5 shadow-[4px_4px_0_0_rgba(113,77,0,1)]">Submit</button>
      </form>
    <?php endif; ?>
  </div>
</div>